...
class LeniaStatistics:
    ...
    def _calc_static_statistics(self, final_obs: torch.Tensor) -> torch.Tensor:
        ...
        # calc initial center of mass and use it as a reference point to
        # "center" the world around it
        mid_y = (size_y - 1) / 2
        mid_x = (size_x - 1) / 2
        mid = torch.tensor([mid_y, mid_x])
        ...
        # activation is number of acitvated cells divided by the number of
        # cells
