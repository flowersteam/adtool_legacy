...
@dataclass
class GenerationParams(Defaults):
    height: int = defaults(512, min=64, max=1024)
    width: int = defaults(512, min=64, max=1024)
    num_inference_steps: int = defaults(16, min=8, max=256)
    guidance_scale: float = defaults(7.5, min=1.0, max=20.0)
    initial_condition_seed: int = defaults(0, min=0, max=999999)


@GenerationParams.expose_config()
