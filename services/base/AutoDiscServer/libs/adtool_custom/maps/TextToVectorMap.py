...
@dataclass
class PromptParams(Defaults):
    seed_prompt = defaults("a photo of a dog on the beach")
    perturbation_scale = defaults(0.001, min=0.00001, max=0.1)


@PromptParams.expose_config()
