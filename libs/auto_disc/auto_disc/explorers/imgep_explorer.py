...
class IMGEPExplorer(BaseExplorer):
    """
    Basic explorer that samples goals in a goalspace and uses a policy library to generate parameters to reach the goal. For reference on the algorithm, [see here.](https://arxiv.org/abs/1708.02190)
    """
    CONFIG_DEFINITION = {}
