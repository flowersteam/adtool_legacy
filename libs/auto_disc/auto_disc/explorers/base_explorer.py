...
class BaseExplorer (BaseAutoDiscModule):
    ...
    def initialize(self, input_space: DictSpace, output_space: DictSpace, input_distance_fn: Callable) -> None:
        """
            ...
            #### Args:
            - input_space: space providing by the last output_representations_callbacks
    ...
    def observe(self, parameters: Dict, observations: torch.Tensor):
        """
            Gives to the explorer the output of the system after using the parameters
    ...
    def optimize(self):
        """
        Optimizes the explorer's sample policy given the discoveries stored
        """
        raise NotImplementedError()
