...
class BaseSystem(BaseAutoDiscModule):
    ...
    The configuration of the class state must be set through 
    ConfigParameters decorators above the system's definition:
    ...
    def reset(self, run_parameters: Dict) -> Dict:
        """
    ...
    def step(self, action: Dict = None) -> Tuple[Dict, float, bool, Dict]:
        """
