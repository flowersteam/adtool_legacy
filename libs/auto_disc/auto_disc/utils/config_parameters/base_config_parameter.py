...
class BaseConfigParameter():
    ...
    #### Usage:
    ```
    @BaseConfigParameter(name="variable1", default=0, kw=1)
    class A():
        CONFIG_DEFINITION = {}
        def __init__(self):
            pass
    ...
    def __init__(self, name: str, default: Any, **kwargs) -> None:
        """
            ...
            - kwargs: other flags for the configuration
        """
    ...
    def check_value_to_set(self, value: Any) -> bool:
        """
            ...
            #### Returns:
            - bool: The return value is always True. All values are accepted 
        """
        return True
