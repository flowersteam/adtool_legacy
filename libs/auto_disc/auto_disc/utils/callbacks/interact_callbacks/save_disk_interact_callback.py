...
class SaveDiskInteractCallback(BaseInteractCallback):
    ...
    def __call__(self, data, dict_info=None, **kwargs) -> None:
        ...
        for save_item in item_to_save:
            folder = "{}/{}/{}/{}".format(self.folder_path, dict_info["experiment_id"], dict_info["seed"], save_item)
        ...
        folder = "{}{}/{}/".format(self.folder_path, dict_info["experiment_id"], dict_info["seed"])
        self.logger.info("New data saved : {} : {} :{}".format(folder, item_to_save, dict_info["idx"]))