...
class ReadDiskInteractCallback(BaseInteractCallback):
    ...
    def __call__(self, filter_attribut=None, **kwargs) -> None:
        ...
        data_path = "{}{}/{}/{}/idx_{}.pickle".format(self.folder_path, filter_attribut["experiment_id"], filter_attribut["seed"], "data", filter_attribut["idx"])
        dict_info_path = "{}{}/{}/{}/idx_{}.pickle".format(self.folder_path, filter_attribut["experiment_id"], filter_attribut["seed"], "dict_info", filter_attribut["idx"])
