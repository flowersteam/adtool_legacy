...
class BaseInteractCallback(BaseCallback):
    '''
    Base class for interaction callbacks used by the experiment pipelines when the experiment was cancelled.
    '''

    def __init__(self, **kwargs) -> None:
        """
            initialize attributes common to all interaction callbacks
